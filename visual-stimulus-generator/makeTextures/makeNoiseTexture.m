...
%Hxy(round(yN/2),round(xN/2),:) = 0;  I don't know why I was doint this

Hxy = fftshift(fftshift(Hxy,1),2);

s = RandStream('mt19937ar','seed',0); 

Im = rand(s,yN,xN,N_Im,'single');  %Make it single instead of double to save memory

Im = round(Im); %make it [0 1] binary
