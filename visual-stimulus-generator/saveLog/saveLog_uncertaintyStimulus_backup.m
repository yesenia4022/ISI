function saveLog_uncertaintyStimulus(seqs)


global Mstate loopTrial TimingInfo

global stimulusFolder scrambledFileNames scrambledContrasts stimOnset
...
%%%
save(fname, 'stimulusFolder', 'scrambledFileNames', 'scrambledContrasts', 'TimingInfo', 'stimOnset');
