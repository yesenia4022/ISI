function saveLog_savedImages(domains,seqs)

%For the SavedImages module (used for texture stimuli)
...
if isempty(domains) & isempty(seqs) %Indicates that it is called from 'play'
