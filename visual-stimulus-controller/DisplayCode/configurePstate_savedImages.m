function configurePstate_savedImages
...
Pstate.param{18} = {'t_duty' 'float'   .5       0             ''};
...
Pstate.param{32} = {'image_folder'   'string'   '/Users/nauhauslab/Desktop/Textures'     0         ''};
Pstate.param{33} = {'fileID'   'string'   '*.png'     0         ''};
Pstate.param{34} = {'fileID_block2'   'string'   '*.png'     0         ''};
Pstate.param{35} = {'block_bit'   'int'   0     0         'binary'};
Pstate.param{36} = {'block_Nimage'   'int'   4     0         '   #flashes/block'};
