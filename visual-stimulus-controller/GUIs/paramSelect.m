...
% Last Modified by GUIDE v2.5 24-Aug-2015 12:19:44
...
modStrings{7} = 'Geometry Calibration';
modStrings{8} = 'Saved Images';
modStrings{9} = 'Natural Movies';
modStrings{10}= 'Uncertainty Stimulus'; % yb
