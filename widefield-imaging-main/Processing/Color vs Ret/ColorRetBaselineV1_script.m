...
set(G_handles.datadir,'string','F:\ISIdata\')
...
% ExpList{idx}.Cexpt = {'u000_001','u000_002'}; %Dilation Experiment
...
% ExpList{idx}.anim = 'rl5';  %retinotopy %%%%First set of Baselines
% ExpList{idx}.Rexpt = 'u004_010'; 
% ExpList{idx}.Cexpt = {'u005_001','u004_000','u004_002','u004_003','u004_004','u004_005'}; 
% ExpList{idx}.areaNames = {'V1'}; %area id
% ExpList{idx}.GtrxName = 'Gtrx_rl5'; %file name that gets saved after running 'alignAllBaselinestoRetinotopy'
% ExpList{idx}.E_yx = [1]; %ignore this
...
% % dont use the one below, use first set of rl7
% % ExpList{idx}.anim = 'rl7';  %retinotopy  %%%%Second set of Baselines
% % ExpList{idx}.Rexpt = 'u003_001'; 
% % ExpList{idx}.Cexpt = {'u003_009','u003_011','u003_012','u003_013','u003_014','u003_015'}; 
% % ExpList{idx}.areaNames = {'V1'}; %area id
% % ExpList{idx}.GtrxName = 'Gtrx_rl7 v1'; %file name that gets saved after running 'alignAllBaselinestoRetinotopy'
% % ExpList{idx}.E_yx = [1]; %ignore this

% ExpList{idx}.anim = 'rl8';  %retinotopy
% ExpList{idx}.Rexpt = 'u002_002'; 
% ExpList{idx}.Cexpt = {'u002_004','u002_005','u002_006','u002_008','u002_009','u002_010'}; 
% ExpList{idx}.areaNames = {'V1'}; %area id
% ExpList{idx}.GtrxName = 'Gtrx_rl8'; %file name that gets saved after running 'alignAllBaselinestoRetinotopy'
% ExpList{idx}.E_yx = [1]; %ignore this

% ExpList{idx}.anim = 'rm2';  %linear baseline
% ExpList{idx}.Rexpt = 'u002_000'; 
% ExpList{idx}.Cexpt = {'u002_008','u002_001','u002_002','u002_003','u002_006','u002_007'}; 
% ExpList{idx}.areaNames = {'V1'}; %area id
% ExpList{idx}.GtrxName = 'Gtrx_rm2'; %file name that gets saved after running 'alignAllBaselinestoRetinotopy'
% ExpList{idx}.E_yx = [1]; %ignore this

% ExpList{idx}.anim = 'rm2';  %log baseline
% ExpList{idx}.Rexpt = 'u002_000'; 
% ExpList{idx}.Cexpt = {'u002_008','u002_001','u002_002','u002_003','u002_006','u002_007'}; 
% ExpList{idx}.areaNames = {'V1'}; %area id
% ExpList{idx}.GtrxName = 'Gtrx_rm2 v1'; %file name that gets saved after running 'alignAllBaselinestoRetinotopy'
% ExpList{idx}.E_yx = [1]; %ignore this

% ExpList{idx}.anim = 'rn1';  %log baseline
% ExpList{idx}.Rexpt = 'u003_000'; 
% ExpList{idx}.Cexpt = {'u003_007','u003_001','u003_002','u003_003','u003_004','u003_006'}; 
% ExpList{idx}.areaNames = {'V1'}; %area id
% ExpList{idx}.GtrxName = 'Gtrx_rn1'; %file name that gets saved after running 'alignAllBaselinestoRetinotopy'
% ExpList{idx}.E_yx = [1]; %ignore this

% ExpList{idx}.anim = 'rm8';  %log baseline
% ExpList{idx}.Rexpt = 'u003_000'; 
% ExpList{idx}.Cexpt = {'u002_007','u002_002','u002_003','u002_004','u002_005','u002_006'}; 
% ExpList{idx}.areaNames = {'V1'}; %area id
% ExpList{idx}.GtrxName = 'Gtrx_rm8'; %file name that gets saved after running 'alignAllBaselinestoRetinotopy'
% ExpList{idx}.E_yx = [1]; %ignore this
...
% % %don't use ExpList{idx}.anim = 'rm0';  %log baseline with U0 retinotopy
% % %don't use ExpList{idx}.Rexpt = 'u000_000'; 
% % %don't use ExpList{idx}.Cexpt = {'u002_007','u002_002','u002_003','u002_004','u002_005','u002_006'}; 
% % %don't use ExpList{idx}.areaNames = {'V1'}; %area id
% % %don't use ExpList{idx}.GtrxName = 'Gtrx_rm0 v3'; %file name that gets saved after running 'alignAllBaselinestoRetinotopy'
% % %don't use ExpList{idx}.E_yx = [1]; %ignore this

% ExpList{idx}.anim = 'rm0';  %log baseline with U2 retinotopy
% ExpList{idx}.Rexpt = 'u002_013'; 
% ExpList{idx}.Cexpt = {'u002_007','u002_012','u002_003','u002_004','u002_005','u002_006'}; 
% ExpList{idx}.areaNames = {'V1'}; %area id
% ExpList{idx}.GtrxName = 'Gtrx_rm0 v4'; %file name that gets saved after running 'alignAllBaselinestoRetinotopy'
% ExpList{idx}.E_yx = [1]; %ignore this

% ExpList{idx}.anim = 'rm0';  %linear baseline with U2 retinotopy
% ExpList{idx}.Rexpt = 'u002_013'; 
% ExpList{idx}.Cexpt = {'u002_007','u002_012','u002_008','u002_009','u002_010','u002_011'}; 
% ExpList{idx}.areaNames = {'V1'}; %area id
% ExpList{idx}.GtrxName = 'Gtrx_rm0 v5'; %file name that gets saved after running 'alignAllBaselinestoRetinotopy'
% ExpList{idx}.E_yx = [1]; %ignore this

% ExpList{idx}.anim = 'rm9';  %log set of baselines missing B6, problems with B1
% ExpList{idx}.Rexpt = 'u001_000'; 
% ExpList{idx}.Cexpt = {'u002_003','u002_005','u002_007','u002_008','u002_012'}; 
% ExpList{idx}.areaNames = {'V1'}; %area id
% ExpList{idx}.GtrxName = 'Gtrx_rm9'; %file name that gets saved after running 'alignAllBaselinestoRetinotopy'
% ExpList{idx}.E_yx = [1]; %ignore this

% ExpList{idx}.anim = 'sb6';  %log set of baselines missing B6, problems with B1
% ExpList{idx}.Rexpt = 'u002_000'; 
% ExpList{idx}.Cexpt = {'u002_014','u002_003','u002_006','u002_007','u002_008','u002_009'}; 
% ExpList{idx}.areaNames = {'V1'}; %area id
% ExpList{idx}.GtrxName = 'Gtrx_sb6'; %file name that gets saved after running 'alignAllBaselinestoRetinotopy'
% ExpList{idx}.E_yx = [1]; %ignore this

% ExpList{idx}.anim = 'ry5';  %log set of baselines missing B6, problems with B1
% ExpList{idx}.Rexpt = 'u001_000'; 
% ExpList{idx}.Cexpt = {'u001_011','u001_001','u001_004','u001_006','u001_007','u001_008'}; 
% ExpList{idx}.areaNames = {'V1'}; %area id
% ExpList{idx}.GtrxName = 'Gtrx_ry5'; %file name that gets saved after running 'alignAllBaselinestoRetinotopy'
% ExpList{idx}.E_yx = [1]; %ignore this
 
% ExpList{idx}.anim = 'sf6';  %log set of baselines missing B6, problems with B1
% ExpList{idx}.Rexpt = 'u001_000'; 
% ExpList{idx}.Cexpt = {'u001_002','u001_005','u001_006','u001_007','u001_008'}; 
% ExpList{idx}.areaNames = {'V1'}; %area id
% ExpList{idx}.GtrxName = 'Gtrx_sf6'; %file name that gets saved after running 'alignAllBaselinestoRetinotopy'
% ExpList{idx}.E_yx = [1]; %ignore this

% ExpList{idx}.anim = 'se3';  %log set of baselines missing B6, problems with B1
% ExpList{idx}.Rexpt = 'u001_002'; 
% ExpList{idx}.Cexpt = {'u001_010','u001_003','u001_006','u001_007','u001_008','u001_009'}; 
% ExpList{idx}.areaNames = {'V1'}; %area id
% ExpList{idx}.GtrxName = 'Gtrx_se3'; %file name that gets saved after running 'alignAllBaselinestoRetinotopy'
% ExpList{idx}.E_yx = [1]; %ignore this

% ExpList{idx}.anim = 'se4';  %log set of baselines missing B6, problems with B1
% ExpList{idx}.Rexpt = 'u001_001'; 
% ExpList{idx}.Cexpt = {'u001_013','u001_002','u001_009','u001_010','u001_011', 'u001_012'}; 
% ExpList{idx}.areaNames = {'V1'}; %area id
% ExpList{idx}.GtrxName = 'Gtrx_se4'; %file name that gets saved after running 'alignAllBaselinestoRetinotopy'
% ExpList{idx}.E_yx = [1]; %ignore this

ExpList{idx}.anim = 'ry7';
ExpList{idx}.Rexpt = 'u001_000_flipped';
ExpList{idx}.Cexpt = {'u001_007','u001_006','u001_005','u001_004','u001_001','u001_011'};
ExpList{idx}.areaNames = {'V1'};
ExpList{idx}.GtrxName = 'Gtrx_ry7';
ExpList{idx}.E_yx = [1];
...
for i = 1:length(expDom)
    ...
    for bL = 1:length(Cexpt) %Loop each baseline
        ...
        %areaNames = ExpList{expDom(i)}.areaNames; %This version overrides
...
%%
% basedom = [.5/16 .5/8 .5/4 .5/2 .5 1]; %for log Baseline experiments
%basedom = [.03 .1475 .265 .3825 .5 1] % for linear baseline experiments
basedom = [.5 .55]; %for dilation comparisons
