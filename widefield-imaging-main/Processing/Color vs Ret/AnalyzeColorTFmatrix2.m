...
sfMap = stim_framerate./sfMap; %cyc/sec.
...
for c = 1:length(cdom)
    ...
    title(['TP Bandpass factor; ' cleg{c}])
...
plotRange = [0 1];
map = sfMap;
imagesc(xdom,ydom,map,'AlphaData',aBound,plotRange), title('temporal period'), axis image, colorbar
% plotExLocs((E_yx-1)/pixpermm)
hold on
