...
bwCell1 = MakeCellMask(5,.5,3,5,temp1);
...
Ntau = 9;
[kern kernblank countmat countmatblank] = getrandposkernel(cellMat,synctimes,bwCell1,Ntau);
%[kern kernblank countmat countmatblank] = getrevcorrkernel5(cellMat1,synctimes,bwCell1,Ntau);
