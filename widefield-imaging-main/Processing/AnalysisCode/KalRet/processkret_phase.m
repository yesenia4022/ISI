...
figure,
subplot(2,2,1),imagesc(ang1*180/pi,'AlphaData',bw), colorbar, colormap hsv, title('90')
%hold on, contour(ang1,'k')
subplot(2,2,2),imagesc(ang3*180/pi,'AlphaData',bw), colorbar, colormap hsv, title('270')
%hold on,contour(ang3,'k')

subplot(2,2,3),imagesc(ang2*180/pi,'AlphaData',bw), colorbar, colormap hsv, title('180')
%hold on, contour(ang2,'k')
subplot(2,2,4),imagesc(ang0*180/pi,'AlphaData',bw), colorbar, colormap hsv, title('0')
