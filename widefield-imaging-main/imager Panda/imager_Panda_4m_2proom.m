...
ACQ.servoCloseVal = 0.4;
ACQ.servoOpenVal = 0.9;
...
ACQ.vid = videoinput('pcocameraadaptor_r2018a', 0, 'USB 3.1 Gen 1');
...
src.E2ExposureTime = 1000000/ACQ.FPS; 

%dum = round(src.AcquisitionFrameRateAbs*100)/100;%Query actual frame rate
dum = 1000000/src.E2ExposureTime; %Query actual frame rate
...
%% Serial communication with iluminator
